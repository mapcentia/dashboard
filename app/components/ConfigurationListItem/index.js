            ...
            <ExpansionPanelDetails>
                <div style={{width: `100%`}}>
                    ...
                    <div style={{textAlign: `right`}}>
                        {this.props.gc2Configuration ? (<StyledExternalLink href={`${this.props.gc2Configuration.vidiUrl}/app/${databaseName}/?config=${url}`} target="_blank" style={{marginRight: `10px`}}>
